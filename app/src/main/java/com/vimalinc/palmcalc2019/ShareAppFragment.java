...
package com.vimalinc.palmcalc2019;
...
import com.vimalinc.palmcalc2019.palmcalc.PalmCalcActivity;
	...
	public void onStart() {
		...
		webAbout.setText(Html
				.fromHtml("OUTDATED INFORMATION -- THIS SECTION TO BE REWRITTEN<br /><br />" +
                        ...
                        "As it's a free product, we do not have the budget to market it in a traditional way. " +
                        "We require you to Support to make this a success and to make it even better in future." +
                        " So please do encourage us by clicking on the Share button for sharing it with your friends, " +
